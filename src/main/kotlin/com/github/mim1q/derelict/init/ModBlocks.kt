...
import com.github.mim1q.derelict.featureset.FeatureSet
...
object ModBlocks {
  val BURNED_WOOD = register(WoodSet("burned"))
  ...
  private fun <T : FeatureSet> register(blockSet: T): T {
    blockSet.getBlocks().forEach { (k, v) -> register(k, v) }
    return blockSet
  }
