...
object ModEntities {
    ...
    val SPIDERLING = register(
        "spiderling",
        ::SpiderlingEntity,
        SpiderlingEntity.createSpiderlingAttributes()
    ) { dimensions(EntityDimensions.fixed(0.7f, 0.7f)) }
    val CHARMING_SPIDER = register(
        "charming_spider",
        ::CharmingSpiderEntity,
