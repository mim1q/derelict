    ...
    class SpiderModel(private val root: ModelPart) : Model(RenderLayer::getEntityCutout) {
        ...
        companion object {
            fun getTexturedModelData(): TexturedModelData {
                ...
                val leftLegs = modelPartData.addChild(
                    "leftLegs",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(0.5F, 21.25F, -0.5F)
                )
                leftLegs.addChild(
                    "leftLeg0",
                ...
                val rightLegs = modelPartData.addChild(
                    "rightLegs",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(-0.5F, 21.25F, -0.5F)
                )
                rightLegs.addChild(
                    "rightLeg0",
                    ModelPartBuilder.create().uv(0, 30).mirrored()
                        .cuboid(-6.5F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F, Dilation(0.0F)).mirrored(false),
                    ModelTransform.pivot(-1.0F, -0.75F, -2.0F)
                )
                rightLegs.addChild(
                    "rightLeg1",
                    ModelPartBuilder.create().uv(0, 26).mirrored()
                        .cuboid(-6.5F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F, Dilation(0.0F)).mirrored(false),
                    ModelTransform.pivot(-1.0F, -0.75F, -0.75F)
                )
                rightLegs.addChild(
